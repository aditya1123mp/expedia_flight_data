...
WebUI.click(findTestObject('Object Repository/calendar_dates/calendar_button'))
...
def today_date = WebUI.getText(findTestObject('Object Repository/calendar_dates/getting_current_date')).trim()
...
if (!(today_date.equals(formattedDate))) {
    ...
    WebUI.click(findTestObject('Object Repository/calendar_dates/previous_button'))
...
def current_date = WebUI.getText(findTestObject('Object Repository/calendar_dates/get_date')).trim()
...
WebUI.click(findTestObject('Object Repository/getting_data_from_the_dates/done_button'))
